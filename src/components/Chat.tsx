        ...
        const response = await fetch('/api', {
            ...
            body: JSON.stringify({
                messages: setting().continuousDialogue
                    ...
                    : [
                          ...messageList().filter(k => k.special === 'locked'),
                          message
                      ],
        ...
        <div ref={containerRef!} class="mt-4">
                    ...
                    <For each={messageList()}>
                        {(message, index) => (
                            <MessageItem
                                message={message}
                                hiddenAction={
                                    loading() || message.special === 'default'
                                }
                                index={index()}
            ...
            <div
                ...
                style={{
                    'background-color': 'var(--c-bg)',
                    width:
                        containerWidth() === 'init' ? '100%' : containerWidth()
                }}
            >
                <div
                    style={{
